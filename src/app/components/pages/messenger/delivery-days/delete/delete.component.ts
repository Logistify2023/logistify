...
export class DeliveryDaysDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DeliveryDaysDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.deleteDeliveryDays(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
