...
export class DeliveryDaysRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DeliveryDaysRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.restoreDeliveryDays(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
