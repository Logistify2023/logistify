...
export class WebServicesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<WebServicesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.restoreWebServices(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
