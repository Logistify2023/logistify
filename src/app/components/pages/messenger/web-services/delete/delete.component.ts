...
export class WebServicesDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<WebServicesDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.deleteWebServices(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
