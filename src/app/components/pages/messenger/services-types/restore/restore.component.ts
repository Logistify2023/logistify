...
export class ServicesTypesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ServicesTypesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.restoreServiceTypes(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
