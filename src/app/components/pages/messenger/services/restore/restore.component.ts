...
export class ServicesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ServicesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.restoreServices(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
