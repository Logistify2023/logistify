...
export class CourierTypesDetailsComponent implements OnInit {
  objectDetails: any = {};
  ...
  columsDetails_Couriers: string[] = ['courier', 'phone', 'email', 'status'];

  constructor(
    private toastr: ToastrService,
    public dialogRef: MatDialogRef<CourierTypesDetailsComponent>,
