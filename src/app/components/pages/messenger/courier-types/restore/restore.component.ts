...
export class CourierTypesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CourierTypesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.restoreCouriersTypes(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
