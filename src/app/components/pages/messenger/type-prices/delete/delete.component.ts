...
export class TypePricesDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TypePricesDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.deleteTypePrices(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
