...
export class TypePricesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TypePricesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.restoreTypePrices(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
