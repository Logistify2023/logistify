...
export class MessengerDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MessengerDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.deleteCouriers(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
