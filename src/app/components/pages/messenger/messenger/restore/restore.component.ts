...
export class MessengerRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MessengerRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiMessenger.restoreCouriers(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
