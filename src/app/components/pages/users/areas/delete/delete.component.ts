...
export class AreasDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AreasDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.api.deleteUserArea(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
