...
export class AreasRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AreasRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.api.restoreUserArea(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
