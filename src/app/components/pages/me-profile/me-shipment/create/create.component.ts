...
import { MeShipmentViewComponent } from './view.component';
...
export class MeShipmentCreateComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MeShipmentCreateComponent>,
  ...
  openModalDetails(id: number) {
    const dialogRef = this.dialog.open(MeShipmentViewComponent, {
      width: '80vw',
