...
export class CostsCenterRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CostsCenterRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.restoreCostsCenter(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
