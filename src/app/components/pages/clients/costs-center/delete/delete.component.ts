...
export class CostsCenterDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CostsCenterDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.deleteCostsCenter(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
