...
export class ProfilesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ProfilesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.restoreClientProfile(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
