...
export class ClientsRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ClientsRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.restoreCustomers(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
