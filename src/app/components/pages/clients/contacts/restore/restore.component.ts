...
export class ContactsRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ContactsRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.restoreContact(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
