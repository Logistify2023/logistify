...
export class TypesDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TypesDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.deleteClientsTypes(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
