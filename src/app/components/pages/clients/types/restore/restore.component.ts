...
export class TypesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TypesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.restoreClientsTypes(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
