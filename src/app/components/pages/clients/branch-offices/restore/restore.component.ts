...
export class BranchOfficesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<BranchOfficesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.restoreBrandOffice(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
