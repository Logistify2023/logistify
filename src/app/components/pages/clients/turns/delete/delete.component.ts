...
export class TurnsDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TurnsDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.deleteTurns(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
