...
export class TurnsRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TurnsRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiCustomer.restoreTurns(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
