...
@Component({
  selector: 'app-incidences-update',
  templateUrl: './update.component.html'
})
export class IncidencesUpdateComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<IncidencesUpdateComponent>,
  ...
  ngOnInit(): void {
    ...
    this.apiShipments.getIncidences(this.data._id, false, false, this.data.dataDeleted).subscribe((e: any) => {
      if (e.result) {
        this.updateForm.setValue({
          id: e.data.id,
          incidence: e.data.incidence,
          incidence_type_id: e.data.incidence_type_id,
  ...
  onSubmit() {
    ...
    this.apiShipments.updateIncidences(data).subscribe(
      (e: any) => {
