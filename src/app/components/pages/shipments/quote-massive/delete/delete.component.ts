...
export class QuoteMassiveDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<QuoteMassiveDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiShipments.deleteQuote(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
