...
export class ReceiversDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ReceiversDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiShipments.deleteReceivers(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
