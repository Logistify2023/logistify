...
export class EventsUpdateComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EventsUpdateComponent>,
  ...
  ngOnInit(): void {
    this.apiShipments.getEvents(this.data._id, false, this.data.dataDeleted).subscribe((e: any) => {
      if (e.result) {
  ...
  onSubmit() {
    ...
    this.apiShipments.updateEvents(data).subscribe(
      (e: any) => {
