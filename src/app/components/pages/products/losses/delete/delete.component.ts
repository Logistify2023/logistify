...
export class LossesDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LossesDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.deleteLosses(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
