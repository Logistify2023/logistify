...
export class LossesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LossesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.restoreLosses(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
