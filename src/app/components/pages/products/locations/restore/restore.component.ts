...
export class LocationsRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LocationsRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.restoreLocation(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
