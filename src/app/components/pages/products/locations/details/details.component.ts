...
export class LocationsDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LocationsDetailsComponent>,
  ...
  ngOnInit(): void {
    this.apiProduct.getLocationByID(this.data._id, true, true, true, this.data.dataDeleted).subscribe((e: any) => {
      if (e.result) {
