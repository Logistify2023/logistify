...
export class SuppliesDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SuppliesDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.deleteSupplie(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
