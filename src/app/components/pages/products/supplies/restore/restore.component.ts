...
export class SuppliesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SuppliesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.restoreSupplie(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
