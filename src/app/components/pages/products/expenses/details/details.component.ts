...
export class ExpensesDetailsComponent implements OnInit {
  ...
  columsDetails_Spendings: string[] = ['spending', 'description', 'price', 'status'];
  ...
  ngOnInit(): void {
    this.apiProduct.getExpenseByID(this.data._id, true, true, this.data.dataDeleted).subscribe((e: any) => {
      if (e.result) {
