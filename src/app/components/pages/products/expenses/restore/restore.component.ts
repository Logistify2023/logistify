...
export class ExpensesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ExpensesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.restoreExpense(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
