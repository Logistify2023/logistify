...
export class UnitsRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<UnitsRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.restoreMeasureUnit(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
