...
export class UnitsDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<UnitsDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.deleteMeasureUnit(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
