...
export class ProvidersRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ProvidersRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.restoreProvider(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
