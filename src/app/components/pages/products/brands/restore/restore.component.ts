...
export class BrandsRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<BrandsRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.restoreMark(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
