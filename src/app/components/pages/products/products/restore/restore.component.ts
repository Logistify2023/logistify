...
export class ProductsRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ProductsRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.restoreProduct(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
