...
export class SpendingsDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SpendingsDeleteComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.deleteSpending(this.deleteForm.get('id')?.value, this.dataDeleted).subscribe(
      (e: any) => {
