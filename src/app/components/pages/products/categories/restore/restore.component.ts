...
export class CategoriesRestoreComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CategoriesRestoreComponent>,
  ...
  onSubmit() {
    ...
    this.apiProduct.restoreCategory(this.restoreForm.get('id')?.value).subscribe(
      (e: any) => {
